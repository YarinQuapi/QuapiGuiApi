package me.yarinlevi.quapiguiapi.types;
...
public class Page {
     ...
     * @param inventory the inventory to view the page in (Must be created before with @see {@link me.yarinlevi.quapiguiapi.helpers.AbstractGui})
     */
